...
<div class="operate">
<form id="statisForm" action="report-list!groupDownStatus2.action" method="post">
<div class="btn">
...
<tr>
	...
	<th><fmt:message key="second.level" /></th>
...
function getPage(page) {
	$("#page").val(page);
	$("#statisForm").attr('action','report-list!groupDownStatus2.action');
	$("#statisForm").submit();
}
/**
 * get group type
 ...
 */
function exportData() {
	var url = path + "/report-list!exportDownStatus2.action";
