...
<div class="operate">
	<form id="queryForm" method="post" action="authenticate-record.action">
		<fmt:message key="search.condition" />
		<fmt:message key="authenticate.result" />
...
<div>
	<table class="linetable">
		<thead><tr>
			<th><fmt:message key='authenticate.time' /></th>
			<th><fmt:message key='authenticate.ip' /></th>
			<th><fmt:message key='authenticate.mac' /></th>
			<th><fmt:message key='authenticate.result' /></th>
			<th><fmt:message key='authenticate.server.ip' /></th>
			<th><fmt:message key='authenticate.server.port' /></th>
		...
		<c:forEach var="log" items="${logList }" varStatus="logStatus">
			<tr>
				...
				<td>${log.stbIp }</td>
				<td>${log.stbMac }</td>
				<td>${log.authStatus }</td>
				<td>${log.watchServerIp }</td>
				<td>${log.watchServerPort }</td>
