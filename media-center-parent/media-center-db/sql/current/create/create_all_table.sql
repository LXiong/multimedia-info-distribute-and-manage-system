...
CREATE table "CITY" (
    ...
    "PROVINCE_ID" VARCHAR2(20) NOT NULL,
	QUERY_WEATHER_ID varchar(30),
	CITY_NAME_PINYIN varchar(30),
...
create table "STB_WARNING_INFO"(
	...
	"STATUS" VARCHAR2(50) default 'waiting_for_processing',
	"SEVERITY" varchar2(20) default '1',
