...
public interface WebControl {
	 ...
	 * @param md5
	 * @param fileSize
	 * @param downloadTimeStr
	 *            Formatted download time string
	 * @param fileVersion
	 * @return
	 */
	public String downloadPolicy(String cityCode, String filePath, String md5,
			int fileSize, String downloadTimeStr, String fileVersion);
	 ...
	 * @return
	 */
	public String downloadSinglePolicy(String filePath, String md5,
			int fileSize, String downloadTimeStr, String fileVersion);
	...
	/**
	 * update one stb or all stbs, usage: updateSoftware(updateType, filePath,
	 * md5, version, mac) will update stb which it`s mac address is #{mac}
	 * usage: updateSoftware(updateType, filePath, md5, version) will update all
	 * stbs which connected to watcher.
	 */
	// public String updateSoftware(String...paramsWithOrWithoutMac);
	/**
	 * you can put the parameters into a map, so you should
	 * map.put("update_type", updateType) and map.put("file_path", filePath) and
	 * .......
	 * 
	 * @param params
	 *            ,
	 * @param mac
	 *            , if no mac, update all stbs, or update one
	 * @return
	 */
	...
	public String sendInstantMessage(Map<String, String> params,
			List<String> macs);

	public String updatePolicyForGroupType(long typeId,
