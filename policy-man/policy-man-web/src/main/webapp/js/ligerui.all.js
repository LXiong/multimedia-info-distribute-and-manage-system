        ...
        return this.each(function() {
            ...
            var g = {
                start: function(e) {
                    ...
                    g.current = {
                        target: g.target,
                        left: g.target.offset().left - (p.container!=null ? $(p.container).offset().left:0),
                        top: g.target.offset().top - (p.container!=null ? $(p.container).offset().top:0),
